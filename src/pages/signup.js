...
import { InputText, Button, Dropdown, Calendar, Password, Checkbox, Dialog, Divider, classNames } from 'primereact';
...
export const Signup = () => {
    ...
    return (
        <div className='surface-card p-4 shadow-2 border-round w-full lg:w-4  maindiv'>
